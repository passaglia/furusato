...
FN_DATA_FOLDER = os.path.join(CACHE_FOLDER, "furusatonouzeidata/")
...
CACHED_FILE = os.path.join(CACHE_FOLDER, "cleandata.parquet")
ROUGH_CACHED_FILE = os.path.join(CACHE_FOLDER, "roughdata.parquet")
...
def getdata():
    if checkfordata():
        ...
        rawfile.extractall(CACHE_FOLDER)
        return
